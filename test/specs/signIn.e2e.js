...
describe('Log in tests', () => {
    ...
    it('Log in with correct credentials', async () => {
        ...
        await $('//android.widget.TextView[@text="Email"]/following-sibling::android.widget.EditText[1]').setValue('airmax@gmail.com');
        await $('//android.widget.TextView[@text="Email"]/following-sibling::android.widget.EditText[2]').setValue('4618237210Qa');
    ...
    it('Log in with incorrect credentials', async () => {
        ...
        await $('//android.widget.TextView[@text="Email"]/following-sibling::android.widget.EditText[1]').setValue('airmax@gmail.om');
        await $('//android.widget.TextView[@text="Email"]/following-sibling::android.widget.EditText[2]').setValue('airmaxairmax');
        await $('//android.widget.TextView[@text="Login"]').click();
    ...
    it('Opening Restore Access popup', async () => {
        ...
        await expect($('//android.widget.TextView[@text="Send"]')).toBeDisplayed();

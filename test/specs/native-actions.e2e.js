...
describe('Native Actions', () => {
            ...
            await driver.performActions([
    {
        ...
        it.only('Hide Keyboard', async () =>{
            driver.startActivity('io.appium.android.apis', '.app.SearchInvoke');
            await $('id=io.appium.android.apis:id/txt_query_prefill').click();
            await browser.pause(2000);
            await driver.hideKeyboard();
            await browser.pause(2000);

//new UiSelector().text("App/Search/Invoke Search")
//.app.SearchInvoke"
})
})
